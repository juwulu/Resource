...
public class HomeFragment extends Fragment implements HomeContract.FragmentView {
    ...
    public void loadGankDatas(final View view) {
        ...
        Call<GankData> gankData = gankService.getGankData(category, 10, page);
        gankData.enqueue(new Callback<GankData>() {
            ...
            public void onResponse(Call<GankData> call, Response<GankData> response) {
                ...
                mItemAdapter = new ItemAdapter(getActivity(), mResults);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (RecyclerView.SCROLL_STATE_IDLE==newState&&mLastItemPosition+2>mLinearLayoutManager.getItemCount()) {
                    Call<GankData> gankData1 = gankService.getGankData(category, 10, ++page);
